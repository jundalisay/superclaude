...
These results each time consist in an avalanche of consumers’ goods
that permanently deepens and widens the stream of real income although in
the first instance they spell disturbance, losses and unemployment. 

If we look at those avalanches of consumers’ goods we again find that each
...
The most important one of those that remain, housing, is
...
Ample provision for the unemployed in particular
...
percentage to increase in the long run. 

The only series covering a
...
It is a typically cyclical series and displays no trend (or a horizontal one). 11 Since this is theoretically understandable—there is no
theoretical reason to call the evidence in question—those two propositions
seem established for the prewar time to 1913 inclusive. 

In the postwar time
and in most countries unemployment was mostly at an abnormally high
level even before 1930. 

But this and still more the unemployment during
...
The indictment stands that in the past—say, roughly, to the end of the 19th century—the capitalist order was not only unwilling
...
and the abilities of the system in full maturity. 
