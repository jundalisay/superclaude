---
heading: "Questions 1-39"
title: "The Questions of Berkeley"
weight: 57
description: "These modern Analytics were not scientific. I expressed this to the Public about 25 Years ago."
c: "gray"
...
Recently, I have been called on to make good my Suggestions.

But the Person, who made this Call, does not think maturely enough to understand, either those Metaphysics which he would refute, or Mathematics which he would patronize, I should have spared my self the trouble of writing for his Conviction. 
...
To the end that you may more clearly comprehend the Force and Design of the foregoing Remarks, and pursue them still further in your own Meditations, I shall add the following Queries.


#### Query 1: Should the Object of Geometry be the Proportions of assignable Extensions?

It there be any need of considering Quantities either infinitely great or infinitely small?

#### Query 2. Should the end of Geometry be to measure assignable finite Extension? 

Did not this practical View first put Men on the study of Geometry?

#### Query  3. Did the mistaking the Object and End of Geometry create needless Difficulties, and wrong Pursuits in that Science?

#### Query  4. Did Men proceed in a scientific Method, without clearly conceiving their Object, the End proposed, and the Method to pursue it?

#### Query  5. Can every assignable number of Parts be contained in some assignable Magnitude?

Is it not absurd to suppose that finite Extension is infinitely divisible?

#### Query  6. Whether the Diagrams in a Geometrical Demonstration are not to be considered, as Signs of all possible finite Shapes of all sensible and imaginable Extensions or Magnitudes of the same kind?

#### Query  7. Is it possible to free Geometry from insuperable Difficulties and Absurdities, so long as either the abstract general Idea of Extension, or absolute external Extension be supposed its true Object?

#### Query  8. Are not the Notions of absolute Time, absolute Place, and absolute Motion abstractedly Metaphysical?

It it possible for us to measure, compute, or know them?

#### Query  9. Don't Mathematicians engage in Disputes and Paradoxes on they do not nor cannot conceive?

Is the Doctrine of Forces not a sufficient Proof of this?

#### Query  10. Whether in Geometry it may not suffice to consider assignable finite Magnitude, without concerning our selves with Infinity? 

And whether it would not be righter to measure large Polygons having finite Sides, instead of Curves, than to suppose Curves are Polygons of infinitesimal Sides, a Supposition neither true nor conceivable?
...
#### Query  36. Whether there can be Science of the Conclusion, where there is not Science of the Principles? 

Whether a Man can have Science of the Principles, without understanding them? And therefore whether the Mathematicians of the present Age act like Men of Science, in taking so much more pains to apply their Principles, than to understand them?
