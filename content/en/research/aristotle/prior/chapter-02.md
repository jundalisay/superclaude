...
There are 3 kinds of affirmative and negative premises.
...
The particular affirmative must convert partially [from particular to particular]. 

For example, if some pleasure is good, then some good will be pleasure.

But the particular negative does not need to convert.

For example, if some animal is not man, it does not follow that some man is not animal.


3. Indefinite

Take a universal negative with the terms A and B. 
