...
Political revolutions are inaugurated by a growing sense which is often restricted to a political community which have been neglected by existing institutions.

Similarly, scientific revolutions are inaugurated by a growing sense from a narrow subdivision of the scientific community, that an existing paradigm could not explain an aspect of nature like it could before.

In both the sense of malfunction that can lead to crisis is prerequisite to revolution. 

<!-- Furthermore, though it admittedly strains the metaphor, that parallelism holds not only for the
...
Scientific revolutions seem revolutionary only to those whose paradigms are affected by them.

To outsiders they may, like the Balkan revolutions of the early twentieth century, seem normal parts of the developmental process. 

<!-- Astronomers, for example, could
...
This parallel between political and scientific development is beyond doubt.

<!-- The parallel has,
however, a second and more profound aspect upon which the
significance of the first depends.  -->

Political revolutions aim to change political institutions.

 <!-- in ways that those institutions themselves prohibit. -->

Their success therefore necessitates the partial relinquishment of one institution in favor of another.

<!-- , and in the interim, society is not
fully governed by institutions at all.  -->

Initially crisis alone attenuates political institutions.
- More people become increasingly estranged from political life 
- Many of them commit to some reconstruction of society in a new institutional framework. 

The society is then divided into competing camps.


<!-- And, once that polarization has occurred, political
...
political institutions, that role depends upon their being partially extrapolitical or extrainstitutional events.
...
The resulting circularity does not make the arguments wrong or even ineffectual. 

The man who premises a paradigm can show what the new scientific practice will be like.


<!-- That exhibit can be immensely persuasive, often compellingly
...
one will doubt that history can supply many others. What is more likely to be doubted than their
...
Does paradigm rejection illuminate more than human credulity and confusion? 

Are there intrinsic reasons why the assimilation of a new sort of phenomenon or a new scientific theory must demand the rejection of an older paradigm?


{{< n n="We answer OF COURSE especially if it is UFO phenomena that can be replicated by a new scientific theory and alleviate so much human suffering" >}}

<!-- First notice that if there are such reasons, they do not derive from the
logical structure of scientific knowledge.  -->

<!-- A new phenomenon might emerge without reflecting destructively upon any part of past scientific practice. Though discovering life on the moon would today be destructive of existing paradigms (these tell us things
...
New sorts of phenomena would simply show an order in nature not seen before. 

New knowledge would then replace ignorance.
...
Of course, science might have developed in that fully cumulative manner. 

{{< n n="We answer NO IT CANNOT because the foundation of current science is matter and not spirit or mind." >}}


Many people have believed that it did so.

**Most still suppose that cumulation is the ideal.**

<!--  that historical development would display if only it had not so often been distorted by
human idiosyncrasy.  -->

<!-- There are important reasons for that belief. In
Section X we shall discover how closely the view of science-ascumulation is entangled with a dominant epistemology that takes knowledge to be a construction placed directly upon raw sense data by
the mind. -->

<!--  And in Section XI we shall examine the strong support
...
Normal research is cumulative. It owes its success to the ability of scientists regularly to select problems that can be solved with conceptual and instrumental techniques close to those already in existence. 

{{< n n="We answer that WE ALSO DO CUMULATIVE RESEARCH. But we do it with the TOTALITY OF KNOWLEDGE from Asia, Europe, aliens, our own Asian traditions, and not just a tiny group of isolated materialistic knowledge. This allows us to create a new science with a new holistic foundation" >}}


<!-- (That is why an excessive concern with useful problems,
...
There are only 3 types of phenomena about which a new theory might be developed.

1. Those already well explained by existing paradigms

{{< n n="Our science can explain existing paradigms easily as the data is already available" >}}
...
2. Those whose nature is indicated by existing paradigms but whose details can be understood only through
further theory articulation. 

{{< n n="The current science NEEDS further articulation because its understanding is WRONG. Ours explains this class also with the same ease, if the data is available" >}}

3. The anomalies

This type alone gives rise to new theories.

{{< n n="Our current science explains these too, such as UFO dynamics and Hubble Tension and James Webb's impossible galaxies. But we need articulation since the data is interpreted in the wrong way." >}}

<!-- These are the phenomena to which
...
But if new theories are called forth to resolve anomalies then the successful new theory must somewhere permit predictions that are different from those derived from its predecessor. 

{{< n n="Yes we made predictions too such as impossible galaxies being the norm, and global inflation to happen by 2020, and a global war by 2028." >}}


<!-- That difference could not occur if the two
...
through independently established theories, did not develop historically without paradigm
...
conservation become part of science.1 -->
...
{{< n n="Our science is compatible with Newton who based gravity on Spirit. But not with the scammer einstein who based gravity on mathematical riemann manifolds." >}}

<!-- It is hard to see how new theories could arise without these destructive changes in
beliefs about nature. Though logical inclusiveness remains a permissible view of the relation between successive scientific theories, it is a historical implausibility. -->

A century ago there was no need for revolutions. But today, this cannot be maintained because of the contemporary interpretation of the nature is accepted.

 <!-- if the most prevalent  and function of scientific theory is accepted. -->
...
The strongest case for this restricted scientific theory is from Einstein vs Newton. 

These two theories are fundamentally incompatible.


{{< n n="They are incompatible because Einstein is a scam as explained by Nikola Tesla." >}}
...
Newton’s was wrong. Today this remains a minority view.2
...
Relativity cannot show that Newtonian dynamics is wrong because Newtonian dynamics still works with most engineers.

<!-- Furthermore, the
propriety of this use of the older theory can be proved from the very
theory that has, in other applications, replaced it.  -->

Einstein’s theory can be used to show that predictions from Newton’s equations will be as good.
...
{{< n n="No. Einstein science merely is based on the 1st Element as Electromagnetism, while Newton is based on the 3rd Element as matter. The 5 Elements is the basis of our correct science" >}}

<!-- Since they could not have had any evidence for such claims, they betrayed the
...
Some variant of this argument can make any theory immune to attack. 

The much-maligned phlogiston theory, for example, gave order to a large number of physical and chemical phenomena. 

<!-- It explained why bodies burned—they were rich in phlogiston—and why metals had so many more properties in common than did their ores. The metals were all compounded from different elementary earths combined with
phlogiston, and the latter, common to all metals, produced common
properties. 

In addition, the phlogiston theory accounted for a number of
...
fire “spoils” the elasticity of a steel spring.3 -->

If these were the only phenomena that the phlogiston theorists had claimed for their theory, that theory could never have been challenged. 
...
which the experimental evidence in hand already deals.4
...
The fullest and most sympathetic account of the phlogiston theory’s
achievements is by H. Metzger, Newton, Stahl, Boerhaave et la doctrine chimique
(Paris, 1930), Part II.
4 -->

A scientist who only sticks to existing applications, gets no surprises, anomalies, or crises. [e.g. Newtonians]

But these are just the signposts that point the way to extraordinary science. 

If positivistic restrictions on a theory are taken literally, then the scientific mechanism ceases to function.

<!--  that tells the scientific community what problems may lead to fundamental change must  

when that occurs, the community will inevitably return to something much like its preparadigm state, a condition in which all members practice science but in which their gross product scarcely resembles science at all.  -->
...
What would such a derivation look like? 

{{< n n="We answer that it cannot, since even Einstein has no concept of spin and is just based on energy volume as E=mc^2." >}}

<!-- Imagine a set of statements, E1, E2, . . . , En, which together embody the laws of
...
and they there still repreVol. II, No. 2
...
This need to change the meaning of established concepts is central to the revolutionary impact of Einstein’s theory. 

<!-- Though subtler than the changes from geocentrism to heliocentrism, fromphlogiston to oxygen, or from corpuscles to waves, the resulting -->

Einstein's conceptual transformation destroys Newton's paradigm. 

<!-- is no less decisively destructive of a previously established paradigm. We may even come to see it as a -->


It is a prototype for revolutionary reorientations in the sciences. 

<!-- Just because it did not involve the introduction of additional objects or concepts, the transition from Newtonian to Einsteinian mechanics illustrates the scientific revolution as a displacement of the conceptual network through which scientists view the world.
...
scientific theory and its successor are real. Though 

The Nature and Necessity of Scientific Revolutions -->

An out-of date theory can always be viewed as a special case of its up-to-date successor, it must be transformed for the purpose. 
...
Assume that the differences between successive paradigms are both necessary and irreconcilable. 

Can we then say more explicitly what sorts of differences these are? 

<!-- The most apparent type has already been illustrated repeatedly.  -->

Successive paradigms tell us different things about the population of the universe and about that population’s behavior. 

<!-- They differ about such questions as the existence of subatomic particles, the materiality of
light, and the conservation of heat or of energy. These are the substantive differences between successive paradigms, and they require
no further illustration.  -->

<!-- But paradigms differ in more than substance, for they are directed not only to nature but also back upon the science that
produced them.  -->

Paradigms are the source of the methods, problem-field, and standards of solution accepted by any mature scientific community at any given time. 
...
<!-- And as the problems change, so, often, does the
...
**The normal-scientific tradition that emerges from a scientific revolution is incompatible and often actually incommensurable with that which has gone before.**

{{< n n="Yes, Newton's 3rd density physics is incompatible with Einstein's wrong 4th density physics, but compatible with Descartes' correct 4th density physics" >}}


The impact of Newton’s work provides a striking example of these subtler effects of paradigm shift. 

He rejectd Aristotle. 

<!--  and scholastic explanations expressed in terms of the
...
In an earlier period, occult qualities had been an integral part of productive scientific work. 

{{< n n="Descartes Physics explains the occult qualities to make them non-occult">}}


<!-- Nevertheless, the seventeenth century’s new commitment to mechanico-corpuscular
...
For corpuscularism in general, see Marie Boas, “The Establishment of the
...
<!-- Yet, though much of Newton’s work was directed to problems and embodied standards derived from the mechanico-corpuscular world view, the effect of the paradigm that resulted from his work was a
...
same sense as the scholastics’ “tendency to fall” had been. 
...
gradually accepted the view that gravity was indeed innate. By the mideighteenth century that interpretation had been almost universally
...
repulsions joined size, shape, position, and motion as physically irreducible primary properties of matter.7 -->

The resulting change in the standards and problem-field of physical science was once again consequential. 

By the 1740’s, for example, electricians could speak of the attractive “virtue” of the electric fluid without thereby inviting the ridicule that had greeted Molière’s doctor a century before. 

<!-- As they did so, electrical phenomena increasingly
...
I give 2 briefer illustrations.


## 1. Lavoisier

Before the chemical revolution, the phlogiston explained why some substances are acidic, others
metalline, combustible, etc. 

<!-- Some success in this direction had
...
argument for the acids.  -->

Lavoisier’s reform, however, ultimately did away with these.

{{< n n="We bring back the phlogiston as interaetherspace. This will help create warm superconductors that are impossible with Lavoisier's shallow framework" >}}

<!--  chemical “principles,” and thus ended by depriving chemistry of
...
Maxwell believed that light waves must be propagated through a material aether. 

<!-- Designing a mechanical
medium to support such waves was a standard problem for many of his
ablest contemporaries. --> 

But he gave no account at all of how the aether could support light waves.

{{< n n="This was actually done by Nikola Tesla via AC current" >}}

<!-- and it clearly made such an account harder to provide than it had
...
Scientists no longer thought it unscientific to speak of an electrical “displacement”
...
These characteristic shifts in the scientific community’s conception of its problems and standards would have less significance to this essay’s thesis if one could suppose that they always occurred from some methodologically lower to some higher type. 

In that case their effects, too, would seem cumulative. No wonder that some historians
...
<!-- Yet the case for cumulative development of science’s problems
...
will be shown to satisfy more or less the criteria that it dictates for itself and to
