...
“The length of the rod” is the distance between these 2 points measured by the measuring-rod already employed, which in this case is at rest.
 ...
 <!-- is also a length which may be designated  -->
...
{{< n n="In Descartes' Physics, the space is inverse of time of frequency. So a faster speed from higher energy will leed to contraction. The difference with Relativity is that the cause is the frequency, and not speed" >}}
...
So we see that we cannot attach any absolute signification to the concept of simultaneity, but that two events which, viewed from a system of co-ordinates, are simultaneous, can no longer be looked upon as simultaneous events when
