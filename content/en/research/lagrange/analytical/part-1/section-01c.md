---
heading: Section 1c
title: The Composition of Forces
description: 
c: firebrick
a: "Lagrange"
date: 2026-03-18
...
{{<  n n="This is explained by Principles of Philopsophy Part 2, Article 31-32. The difference in Descartes' system is that the forces depend on the state of the body" >}}
...
1º That, if two forces act on the same point in different directions, they have for resultant a single force which bisects the angle between their directions when the two forces are equal, and which is equal to their sum when this angle is zero, or to their difference when the angle is 180°;
2º That equimultiples of the same forces, or any forces proportional to them, have a resultant which is an equimultiple of their resultant or proportional to this resultant, the angles remaining the same.
