---
heading: Section 1b
title: The 4 Principles of Dynamics
description: 
c: firebrick
weight: 7
a: "Lagrange"
...
<!-- , either immediately as in ordinary impact, or by means of inextensible threads or levers to which they are attached, or in general by any other means whatsoever,  -->

<!-- For here the forces acting on the bodies are unknown, and one must deduce these forces from the action that the bodies must exert among themselves, according to their mutual arrangement. -->
...
{{< n n="Elastic collisions refer to solids" >}}
...
{{< n n="Descartes was correct because the energy is transferred to the other elements such as electromagnetism and aether (sound)" >}}
