...
Moreover we have integrated the above equation proposed by a series (488), thus
...
But the distance of the vertex of the curve C is at a distance AC from the
gk
...
with which values substituted in the equation, we have 
...
Now it is then the case that q = n = xz
