...
It is needed in finding the nature of the curve AMC that either
...
But if the integration cannot be performed conveniently, either equation is
to be differentiated on putting n to be a variable, and afterwards on putting dt = 0, from
the two equations found v must be eliminated, from which an equation is produced
...
To the other equation to be differentiated I put :
and it becomes :
dt = Pdv + Qdp .
...
or on putting x = rp. This value is substituted in place of v in the equation or in this
Indeed in the case is which m = 12 or the resistance is proportional to the speeds, then the
equation becomes pdv = vdp or v = αp and thus it follows to be zz = ax; as in this hypothesis of the resistance the curve AMC is a
circle everywhere as in a vacuum.

According to other hypotheses of the resistance, unless
...
499. If we put v = up, then: pdv–vdp = ppdu.
