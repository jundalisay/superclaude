...
x constant, which is given by dz = Qdy . Let MF be the normal to this curve [in the yz
...
and Qq and Mm are produced in both directions, of which the first meets πρ in r, and the
...
dx 2 + dy 2 + dz 2 + zdz
dx 2 + dy 2
; all quantities to first order in the elements.]:
...
crosses the element Qq produced.
