...
If besides it should be that

then the body is rotating in a circle, the radius of which is f, with a speed corresponding
to the height

The length of the pendulum completing whole oscillations in the same time is equal
to
...
progresses by almost 390 in succession.
...
the fraction in a series, which is the following :
