...
with these connected together there is given 

Therefore with the element Mm given then the following element mμ on the shortest line
is found; for it is given by : and the values of ddy and ddz have been found. Whereby hence the position of any
following element is determined and the nature of the shortest line by some projection of
these is known. Q.E.I.

## Corollary 1

834. If, in the equation for the surface P and Q are given in terms of x and y only, then the equation
denotes the projection of the shortest line in the plane APQ.
...
XR = −Qz − y . Now the length of the radius of osculation (73) is equal to 
...
E044] : hence [on differentiation] there becomes : [p. 468]
and
and finally :
...
842. Therefore this pressing force either increases or decreases the centrifugal force, according as the direction of this force falls either opposite to the direction of the radius
...
the direction of this force either pulls the body this way or that.