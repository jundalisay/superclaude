...
The normal pressing force is considered (Fig. 91), and the direction of this is along
...
Finally, since the force of deflection is in the direction MG : as
...
Then the cosine of the angle that the direction of the force E makes with MG is equal
to :
...
height corresponding to the speed at M, then (849), if in place of T there is put the tangential force arising from the resolution of the
