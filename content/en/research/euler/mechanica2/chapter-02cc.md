...
pdx
dimensions 12 . Moreover this is shown elsewhere, in Vol. VII Comment.
...
value of a found must be substituted into the equation between x and y. Q.E.I.
...
equation for the curve CMM : or this
...
CMM augmented or diminished in the same ratio as AC or b is augmented or diminished.
...
If the equation between the orthogonal coordinates x and y is desired, from the
equation
...
from one easy given, it is possible to construct any number you please.
