...
following sketch for the similar triangles]
...
[Note that on putting u = cosθ' , this 2
...
the expression for u subsequently quoted below.
...
From which it is apparent, if λ is negative, the value of u can only be negative, that which is understood from the differential equation. Truly in a similar manner, ...
