...
find here are completely similar to these previous ones,; only in
...
Mr = dx = 0 and dy = ds , giving dv = − Pds and r =∝ as before. Therefore only the tangential speed of the body is affected, and the direction of the motion is clearly not
changed.(544). [p. 231]
Corollary 5.
...
cases. [Euler now solves simple projectile motion using his general equations.
