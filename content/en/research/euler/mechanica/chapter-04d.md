...
397. For a body moving in a medium with uniform resistance, which makes the resistance to be in proportion to some power of the speeds, to determine the time in
...
speed somewhere at C, the time also, from which it reaches A from C, can be known from
