...
The force acting is called g, and the speed with which the body is projected from
...
now the element of arc ds = dx + dy , and
...
focus point F of the parabola sought is found (573, 575). Again the normal DE through F
