...
date: 2025-03-20
weight: 8
description: "Every body that is moving has a speed"
author: "Euler"
a: Euler
c: "firebrick"
---
...
from the distances the bodies travel in the same time (18). On account of which C : c = S .. : t , or C : c = TS : st . From which it follows that the speeds are directly as the distances and inversely as the times, with which these are traversed. Q. E. D.
