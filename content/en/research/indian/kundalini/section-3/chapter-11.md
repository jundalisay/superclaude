...
So far we have given a series of practices for each of the individual chakras. In this chapter we will describe practices which are concerned with overall awakening of the
chakras. 
...
synchronize the mantra Оm with the pulsation in the ajna chakra region. 

Оm, Оm, Оm, Оm, Оm, should be the form of your awareness with the pulsation of ajna chakra. 

Count the pulsation 21 times. Now begin to practise ashwini mudra. Do not be concerned with
...
back to manipura chakra, within the spinal column, directly behind the navel. 
...
feel the vast heart space filling up. 

Feel the heart space directly - contracting and
...
At first the musical scale of the harmonium is ascended very slowly while the awareness begins in mooladhara and ascends sushumna from one chakra to the next,
...
The voice is integrated with the notes. The names of the chakras are chanted very precisely. 

The names themselves are mantras, and if intoned with the correct note and pronunciation, each center can be set vibrating, and the sushumna passage and the whole
