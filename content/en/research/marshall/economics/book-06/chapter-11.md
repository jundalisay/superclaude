...
The chief benefit which an increase of capital confers on labour is not by opening out to it new employments, but by increasing the joint product of land, labour and capital (or of land, labour and waiting), and by reducing the share of that product which any given amount of capital (or of waiting) can claim
as its reward.
...
with normal profits, but not more. 

(Something must be added to or subtracted from this net product to find the normal wages of a worker whose efficiency is more or less
