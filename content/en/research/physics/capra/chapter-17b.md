...
By defining the structure of a hadron as its tendency to undergo various reactions, S-matrix theory gives the concept
of structure an essentially dynamic connotation. At the same time, this notion of structure is in perfect agreement with the experimental facts. Whenever hadrons are broken up in
...
can be photographed in the bubble chamber. The picture on page 267 and the ones in Chapter 15 are examples of such net-
works of reactions.

Although it is a matter of chance which network will arise
in a particular experiment, each network is nevertheless structured according to definite rules. These rules are the
...
The probability for two colliding hadrons to
...
well-known resonance phenomenon encountered in connection with vibrations. In the case of sound, for example, the
...
states. In S-matrix theory, as in field theory, the interaction forces are associated with particles, but the concept of virtual
...
In fact, the diagram can be rbtated further, and individual lines can be ‘crossed’
