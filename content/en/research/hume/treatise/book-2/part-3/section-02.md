...
We imagine we feel that the will itself is subject to nothing because when our actions are denied, we are provoked to try.
...
It is because the causes of these actions:
- are only momentary
...
It is because a hasty temper, though a constant cause in the mind:
...
When by any alteration of these principles they cease to be just proofs, they likewise cease to be criminal.
