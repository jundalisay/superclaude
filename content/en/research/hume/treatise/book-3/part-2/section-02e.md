...
description: "The rules of justice are established merely by interest, but their connection with interest is singular and different each time"
c: "steelblue"
weight: 18
writer:
  name: David Hume
...
Injustice still displeases us even when it is so distant from us as to not affect our interest because we consider it as:
...
I shall make a similar reflection regarding promises which I hope will remove all odium from the foregoing opinions on justice and injustice.
