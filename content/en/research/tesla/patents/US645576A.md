...
2. The conductivity imparted to the air or gases increases very rapidly both with the augmentation of the applied electrical pressure and with the degree of rarefaction, the law in this latter respect being, however, quite different from that heretofore established.
...
* The source G, forming one of the elements of the transmitter, was a condenser of a capacity of about four one-hundredths of a microfarad ($\approx 0.04\ \mu\text{F}$) and was charged from a generator of alternating currents of 50,000 volts pressure and discharged by means of a mechanically operated break 5,000 times per second through the primary O.
