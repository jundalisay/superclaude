...
To the understanding of which, we are to note, that a Fifth is never heard in Musick, but that, in some sort, an acuter Fourth is withall advertised; which follows from what we have sayd (page 11), that in an Unison, there is, in some sort, resounded an acuter Eighth.
