...
**Emanuel Myers:** My name is Emanuel Myers from Chicago, Illinois. 

Are there any practices or images or story structures that would bring me closer to the Essassani frequency? 


**Bashar:** Just follow the formula.

When you act on your passion, you raise your frequency. 

When you raise your vibrational frequency of energy, you become a more sensitive receiver and antenna for higher frequency information and energy from other higher-level sources. 

So the way to match the vibration more readily of our civilization, Essassani, is to simply follow the formula as precisely as you can, let go of the beliefs that don't serve you, and recognize the automatic tools that come into play—like synchronicity being the organizing principle of your life—and let them operate in the way they naturally operate without having to worry about whether or not you're off the path. 

<!-- Just let them do what they need to do, and know that you will attract everything you need to live a fulfilled life. And by raising your frequency in that way, you will match whatever vibrational resonance you need to that will be of best service to you and to the rest of your planet, as well as to the cosmos. -->


## Rational Thinking, Discomfort, and Memory

**Gabriela:** I'm Gabriela from Canada. in the formula, you act on the excitement to the best of your ability until you can take it no further. Yes. Um, how does the formula incorporate rational thinking or logic?


**Bashar:** you can be rational and logical about what it is you're experiencing. You can understand it from that point of view. 

But it's not really about taking that too far. It's not about overthinking or overcomplicating the idea. It's more about allowing things to flow in a natural way, knowing that that's how things work. Whatever it is that then does manifest, you can think about in any way, shape, or form you would like to, as long as the thinking process doesn't interfere with the natural flow of what synchronistically needs to come to you to serve you.
...
### Story Structure, Flash Matrix, and Government

**Michael:** This is Michael from Tel Aviv. You say that story structure is built into our psyche. This allows us to have such beautiful experiences. Is it only built into the psyche, or is it the same or similar on the spirit levels?

{{< l a="Bashar" >}}
It exists on many different levels.

In a certain way, it's not experienced quite the same way as a crystallized form other than in physical reality. There is more malleability to it, different perspectives that can be added, different elements that come up on different levels of reality than the elements that are part of story structure on Earth.

The story structure can also change from civilization to civilization, even within the physical universe. But the basic underlying idea of story structure exists on many levels as simply the patterns or frequencies of energy that are incorporated into consciousness on that level that are most available or receptive to the delivery and the retention of information and knowledge.
{{< /l >}}

{{< r a="Asker" >}}
About the Flash Matrix that you shared with us before. should we have the spirals 55 in one direction and 34 in another, like the sunflower pattern? Or it would be wise to copy from nature?
{{< /r >}}
...
{{< r a="Asker" >}}
Does the end of each spiral touch the crystal at the center and at the periphery of the hemispheres? Or is there a small distance in between them?
{{< /r >}}
...
{{< r a="Asker" >}}
Okay. And is there a measurement to that gap that we should be aware of?
{{< /r >}}

{{< l a="Bashar" >}}
It will depend upon the scale of what you are creating, of course. But the idea is it should be in proportion. In proportion. The same kind of gap as exists between the synapses of your brain.
{{< /l >}}

{{< r a="Asker" >}}
But in brain... oh wow. Interesting. But in proportion to the scale. Okay. Yeah, we could figure that out. Thank you.
{{< /r >}}

{{< r a="Asker" >}}
Um, last question on the Flash Matrix: is 2 mm acrylic a good insulator for the spirals?
{{< /r >}}

{{< l a="Bashar" >}}
Perhaps it would suggest you go to three. Three millimeters.
{{< /l >}}

{{< r a="Asker" >}}
Okay. Because they are interwoven, the spirals. We understand. Yes. Okay. 3 millimeters. Awesome. Thank you.
{{< /r >}}

{{< r a="Asker" >}}
Um, from your perspective, what would you say the purpose of the government is? A government, or the government?
{{< /r >}}

{{< l a="Bashar" >}}
Well, again, like in our system, we have those that amplify guidance, amplify synchronicity, allow there to be a kind of a vibrational pattern set up of energy that serves the best of all concerns, so that our experience of synchronism can continue along the path of least resistance for all individuals contained within that particular society or system. So it's more of an amplification and guidance system by individuals who are willing to serve in that capacity.
{{< /l >}}

{{< r a="Asker" >}}
Right. So it sounds like that can be translated uh, in our reality in a very similar way as almost an education system that is sharing with people the nature of reality.
{{< /r >}}

{{< l a="Bashar" >}}
It's certainly closer to the educational idea. Yes.
{{< /l >}}

{{< r a="Asker" >}}
Right. And making sure everyone has, in a sense, what they need, at least his basic needs, in order to thrive.
{{< /r >}}

{{< l a="Bashar" >}}
Yes. Yes. Yes. Yes. Okay. Really like that.
{{< /l >}}

{{< r a="Asker" >}}
Um, and I'm not sure if you can comment too much on this, but our Constitution. Is there anything that, if you scan our Constitution, that you would see would be a great either addition or transformation that you would see as beneficial to us?
{{< /r >}}

{{< l a="Bashar" >}}
Well, certainly the idea of not being in a position where you need to explain the obvious. In other words, you have many different changes and addendums and alterations and things that you bring about in your laws, including in your Constitution, because you feel that individuals don't understand with enough clarity the basic ideas that are there to begin with. In general. In other words, you have said that certain ideas ought to be self-evident, but apparently to many of the people on your planet, they're not. And therefore, you have to augment them all the time with all sorts of other laws and rules to make sure that people understand the original intent.
...
{{< r a="Asker" >}}
Right, right. Because in a sense, that could even create more separation.
{{< /r >}}

{{< l a="Bashar" >}}
And yes, exactly. Because you feel the need to have to include something that should have already been included in the basic concept to begin with.
{{< /l >}}

{{< r a="Asker" >}}
Yeah. Kind of like a double standard, in a sense.
{{< /r >}}

### Crystal Skulls, Symbols, and Nanotechnology

{{< r a="Asker" >}}
I have gotten the intuition that there is a crystal skull underneath the Hill of Tara in Ireland. The second one was Newgrange. My instinct said is Newgrange is very connected to the Sirian vibration.
{{< /r >}}

{{< l a="Bashar" >}}
No comment. You are in mid-process. We cannot intervene.
{{< /l >}}

{{< r a="Asker" >}}
I've asked and received some myself, but I was going to ask you to share a circuit, a symbol for Humanity at this time to come into greater balance.
{{< /r >}}

{{< l a="Bashar" >}}
That which might be called in the ancient times the symbol of the migrations, or four directions: a circle with an equidistant cross in the center, representing the idea of all the directions, all the races coming together in unity and expanding therefrom.
{{< /l >}}

{{< r a="Asker" >}}
I had a dream with you that was very exciting. You came to me and you said there is going to be an invention a type of clothing that will be either renewable or will be more efficient, that would change things very rapidly, unexpected ways in your reality.
{{< /r >}}

{{< l a="Bashar" >}}
Yes. This is a nanotechnological invention.
{{< /l >}}

{{< r a="Asker" >}}
Okay. And is there a time frame that you see is that being...?
{{< /r >}}

{{< l a="Bashar" >}}
No longer than 20 years. But we cannot pinpoint it at this time.
{{< /l >}}

{{< r a="Asker" >}}
Okay. And what are the effects that that may ripple out?
{{< /r >}}

{{< l a="Bashar" >}}
Well, the idea is the versatility of the nanotechnological fabrics that can perform many different kinds of functions in different kinds of environments, and therefore can allow people to become more adaptable to different environments and allow them to thrive in those environments because of the adaptability of the suit that they are wearing.
{{< /l >}}