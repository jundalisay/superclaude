...
If there is truly only a dimensionless point and a single timeless moment—the here, the now of everything—and yet you are capable of experiencing what appears to be, what feels like, different places at different times, movement, change, change over time, moving around to different locations within the idea of space, you can experience that. 
...
Mirrors can be used as a symbol, a reflection, a permission slip to put you in touch with the idea that you could be looking at a parallel reality version of yourself. I'm not saying that's always the case. I'm simply saying it's a tool that can be used that way if your consciousness seems to bend in that direction, because it's all about light, it's all about energy, it's all about frequency. And therefore mirrors are symbolic of the idea of mirroring, and parallel realities are symbolic of mirroring. A mirror can be used as a window if your consciousness bends that way as a permission slip, if you're so inclined. 


Now please prepare yourself for the idea of a parallel reality meditation that you know is going on in multiple parallel realities simultaneously. Pick the one that works for you, relax, breathe, and enjoy.

## The Parallel Reality Mandala Meditation

Allow your breathing to be deep exercise, allow your breathing to be deep and even. Use whatever accompaniments of sound, imagery, and lights you wish, and allow yourself to begin to imagine a mandala, the idea of geometric patterns in any way, shape, or form that they may come to you, in whatever colors, whatever lines, shapes may appear, dimensional or flat, doesn't matter. 

You can allow yourself to use imagery that has been used before that you may or may not be familiar with. You can look up mandalas in your own free time to find one that you may be attracted to, or more than one. You can allow it to shift kaleidoscopically in your mind and your neur imagination as you imagine the mandala. In fact, it might even be more beneficial, in fact it might even be more beneficial to do so, to allow it to shift and change, to rotate, to change into different kinds of geometric shapes, sending out a multitude of points, star-like shapes, circular shapes, Flower of Life shapes, whatever may work for you.

**Visualizing the Vibrational Connections**

But understand that these are representative, in general sometimes more specifically but in general, of the way in which you connect vibrationally to different parallel reality moments and Frames to inform and build the idea of your own timeline by connecting All Around by looking from different perspectives, looking inward, looking outward. You may see the mandala shift moving outward, radiating lines; you may see it moving inward simultaneously; you may see it as double spirals; you may see it as tetrahedrons; you may see it as merkabas; you may see it in a multitude of ways. 

Just know that it is generally representative of the vibrational patterns within your Consciousness that are responsible for experiencing what you now experience to be different shifts in space and time, to create and construct the idea of a timeline from different parallel points, different choices, those that are relevant, those that will build your theme of exploration, those will allow you to experience the fullness of your life, the fullness of who and what you are as this personality.

**Connecting to the Oversoul**

Just focus on the mandala, see it touching different points, see it reaching out into different parallel realities, see it pulling back information into you that you need, experiences of other versions of yourself on the greater being that you are. Let yourself gain the perspective of the overs soul that has multiple simultaneous incarnations in a variety of civilizations, not only on a multitude of Earth civilizations but of other planetary civilizations, spiritual experiences, multi-dimensional physical and non-physical experiences. 

Allow the mandala to reach into the deepest dimensions and farthest Dimensions, expressing the heart and soul and the seed of all that is, reaching out and creating all the Reflections in the infinite Hall of Mirrors that is existence, reflections of itself to itself, experiences of itself by itself in all the ways that it can, in all the ways that it is, in all the ways that existence can express itself and experience itself as all of the aspects of itself. The whole and the all are the one together see the together see the mandala as it informs you, as it feeds you, as it brings you advice, information, inspiration, and Imagination as allows you to choose the multi-spectral, multi-dimensional fruit that you can pluck from this Mandela tree that brings you all you need to feed you, to nourish you, to replenish you, to allow you to change in the ways that are important for you.

**The Dynamic Energy Pattern of All That Is**

See it as a constantly Dynamic interdimensionally changing fluctuating energy pattern that feeds you constantly and never ends, that always always turns within and with simultaneously in all directions at once, multi-dimensionally. The multi-dimensional meraba of your expression of Consciousness and existence, the unconditional love and support that never ends, that is infinite in all directions, finite within itself in terms of each individual experience, but infinite in the number of experiences you are having simultaneously. 

See the mandala, use the mandala, breathe the mandala, be the mandala. It is your vibrational pattern, your core truth in a multi-dimensional expression. Breathe it in, feel it, ride the wave of it, feel the vibrations of it, the ripples in it pulsing in and out to infinity and back into the center, in and out, breathing, pulsing the breath of all that is, the mandala of your existence, your Consciousness, the shapes that represent your connections, your parallel realities, All That You Are Here and Now. 

Breathe it in, feel the vibration reson ating within your core in your solar plexus as it radiates outwards, as it comes back into you, as it matches the beat of your heart, as it forms the brilliant light, the spark and Seed of Light Within you that is the seed of all that is.

## Being the Mandala

See the mandala, feel the mandala, be the mandala. Be the vibrational pattern of your core truth, the truth you know yourself to be. Just be it. It doesn't have to be anything but just being right now. Just feel the vibrations throughout your body, feel every cell in your body resonating to it, harmonizing with it like an orchestra, a beautiful harmonic of every cell and every atom vibrating in a chord of every subatomic particle of every aspect of your DNA harmonizing with this mandala vibration that is you. 

Stretching into the multiv into all parallel realities and all Dimensions, bringing back what you need from everywhere and every when and everyone as you send out to everywhere and everyone and everywhere what they need, and being of absolute service to all so that you may be served. It is a Veo of service. The mandala is your connecting link to all that is, it is it is your expression of all that is, it is all that is expressing itself as you, your unique vibrational pattern. The beauty, the Artistry, the creativity, the love, the unconditional support, the unconditional existence, the unconditional vibration, the Unconditional Love of All That is. 

Resonance is all there is. The existence is all there is. Breathe It In, Breathe It Out, breathe it in and breathe it out, breathe it in and breathe it out. Be the mandala, be the vibration, be the Consciousness, be the existence, be all that you are, for it is beautiful and it is required. Float with it, keep it with you, use it.
