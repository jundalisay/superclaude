...
**Bashar:**
It can. What is meant by "live without belief" is the idea of going back to the essential self in a neutral state so that you can be a clear conduit for whatever needs to be expressed. You will still have beliefs (e.g., that you are physical), but this doesn't impede you from going back to a neutral state where beliefs are not paramount, but rather *knowing* who you are. Knowing supersedes belief. Meditation can help you reach this state if it is a permission slip that works for you.

***

# Topic 12: Pregnancy, Chakras, and Levels of Consciousness
...
**Bashar:**
Excitement does *not* lead to struggle. If you encounter struggle, it is no longer your highest excitement *if you define it negatively*.
