...
{{< r a="Don Elkins" >}}We eliminated our meditation prior to the session. Would Ra comment on that?{{< /r >}}
...
Firstly, within the body of knowledge which those healers known among your peoples as medical doctors have is the use of harsh chemical substances which you call medicine. These substances almost invariably cause far more changes than are intended in the mind/body/spirit complex. However, in this instance the steroids or, alternately, the antibiotic family might be useful in the complete removal of the difficulty within which the working is still able to thrive. 
...
{{< l a="Ra" >}}
No. There is no greater cause for caution than previously and, yes, the phrases of which you speak shall aid the entity. 
...
Keep in mind that this entity is harvestable third density.{{< /l >}}
...
{{< r a="Don Elkins" >}}I was wondering if I was correct in my assumption that the reason for the growths was a state of anger in the cat, Gandalf, because of the introduction of the newer cats into his environment. Was I correct?{{< /r >}}

{{< l a="Ra" >}}The original cause of what you call cancer was the distortion caused by this event. The proximate cause of this growth is the nature of the distortion of the body cells which you call cancer.{{< /l >}}

{{< r a="Don Elkins" >}}Are there any other cancerous growths at this time within the cat Gandalf?{{< /r >}}

{{< l a="Ra" >}}Yes.{{< /l >}}

{{< r a="Don Elkins" >}}Can we alleviate those and, if so, how and where are they?{{< /r >}}

{{< l a="Ra" >}}
None can be alleviated at this space/time nexus. One is located within the juncture of the right hip. 

Another which is very small is near the organ you call the liver. There are also small cell distortions under the, we may call it, arm, to distinguish the upper appendages, on both sides.{{< /l >}}


{{< r a="Don Elkins" >}}Is there anything that we can do to alleviate these problems— other than surgical— that would have a good effect to help Gandalf alleviate them?{{< /r >}}

{{< l a="Ra" >}}
Continue in praise and thanksgiving, asking for the removal of these distortions. There are two possible outcomes. Firstly, the entity shall dwell with you in contentment until its physical vehicle holds it no more due to distortions caused by the cancerous cells. 

Secondly, the life path may become that which allows the healing. We do not infringe upon free will by examining this life path although we may note the preponderance of life paths which use some distortion such as this to leave the physical body which in this case is the orange-ray body.
{{< /l >}}

{{< r a="Don Elkins" >}}Does the cat Fairchild have any of this same type of problem?{{< /r >}}

{{< l a="Ra" >}}Not at this space/time nexus.{{< /l >}}

{{< r a="Don Elkins" >}}Was it necessary for the cat Gandalf to be a mind/body/spirit complex harvestable third density to have the anger result in cancer?{{< /r >}}

{{< l a="Ra" >}}No.{{< /l >}}

{{< r a="Don Elkins" >}}Then any mind/body complex can develop cancer as a result of anger. Is this correct?{{< /r >}}
...
{{< r a="Don Elkins" >}}
That is perfectly fine with us. That noise occurs at the forty-five minute time since the tape is forty-five minutes on a side. 

I would just ask as a final question, then, if the new table that Jim has built for the appurtenances is satisfactory to hold them since it will give us more room to walk around the bed, and if it is better to leave it in its natural condition as it is, or to coat it with linseed oil or varnish or paint?{{< /r >}}


{{< l a="Ra" >}}We view this appurtenance. It sings with joy. The pine vibrates in praise. Much investment of this working in wood has been done. It is acceptable. We may suggest it be left either as it is or rubbed with the oil which also is easily magnetized and holds the proffered vibration to a profound extent.{{< /l >}}
