...
{{< l a="Ra" >}}
Walk around Carla in a circle. Then each should expel breath forcibly, approximately 2.5 feet above Carla's head. Then walk again about her.

[This was done as directed.]
{{< /l >}}

{{< r a="Don Elkins" >}}Could you tell me what was wrong or what caused the necessity for the re-walking of the circle and the purpose of the expelling of breath?{{< /r >}}

{{< l a="Ra" >}}
Carla was under specific psychic attack at the time of the beginning of the working. 
...
Thus the circle was properly walked. The breath of righteousness expelled the thought-form and the circle again walked.{{< /l >}}

{{< r a="Don Elkins" >}}Was the attack successful in creating any further distortion of Carla's body?{{< /r >}}

{{< l a="Ra" >}}Yes.{{< /l >}}

{{< r a="Don Elkins" >}}What is the nature of this distortion?{{< /r >}}

{{< l a="Ra" >}}
This thought-form sought to kill Carla by working with the renal distortions which are vulnerable to one which knows the way to separate time/space molding and space/time distortions which are being unmolded, vulnerable as before the healing.
{{< /l >}}

{{< r a="Don Elkins" >}}What detrimental effect has been done?{{< /r >}}

{{< l a="Ra" >}}
There will be some discomfort. However, we were fortunate in Carla was very open to us and well-tuned. 

Had we not been able to reach her and instruct you, her body would soon be unviable.{{< /l >}}

{{< r a="Don Elkins" >}}
Will there be any lasting effect from this attack as far as her body is concerned?{{< /r >}}

{{< l a="Ra" >}}This is difficult to say. We think that no lasting harm or distortion will occur.

The healer was strong, The bonds taking effect in the remolding of these renal distortions were effective. 
...
It seems that all is well except for some possible discomfort which shall be attended if persistent.{{< /l >}}


{{< r a="Don Elkins" >}}
Was the opening that was made in the protective circle planned to be made by the Orion entity? 

Was it a specific planned attempt to make an opening, or was this something that just happened by accident?{{< /r >}}
...
{{< r a="Don Elkins" >}}Would you expand on what you just said about the expelling of breath? I wasn’t quite sure what you meant.{{< /r >}}

{{< l a="Ra" >}}The repetition of that performed well at this working is advisable if the circle is walked in less than the appropriate configuration.{{< /l >}}
...
{{< r a="Don Elkins" >}}Are there other groups of those who are on the service-to-self path joined with those from the Orion constellation? For instance, those of Southern Cross, are they presently working for the same type of harvest with respect to Earth?{{< /r >}}

{{< l a="Ra" >}}These you mention of Southern Cross are members of the Orion group. It is not, shall we say, according to understood wording that a group from various galaxies should be named by one. However, those planetary social memory complexes of the so-called Orion constellation have the upper hand and thus rule the other members. You must recall that in negative thinking there is always the pecking order, shall we say, and the power against power in separation.{{< /l >}}

{{< r a="Don Elkins" >}}By creating as large a harvest as possible of negatively oriented entities from Earth, then, the social memory complex of the Orion group gains in strength. Am I correct in assuming this strength then is in the total strength of the complex, the pecking order remaining approximately the same, and those at the top gaining in strength with respect to the total strength of the social memory complex? Is this correct?{{< /r >}}

{{< l a="Ra" >}}This is correct. To the stronger go the greater shares of polarity.{{< /l >}}

{{< r a="Don Elkins" >}}Then what do the ones at the top of the pecking order of the Orion group— well, let me first ask this: Are we talking about the fourth-density group now?{{< /r >}}

{{< l a="Ra" >}}There are fourth and a few fifth-density members of the Orion group.{{< /l >}}

{{< r a="Don Elkins" >}}Then is the top of the pecking order fifth-density?{{< /r >}}

{{< l a="Ra" >}}This is correct.{{< /l >}}

{{< r a="Don Elkins" >}}What is the objective; what does the, shall we say, the leader, the one at the very top of the pecking order in fifth-density Orion, have as an objective? I would like to understand his philosophy with respect to his objectives and plans for what we might call the future or his future?{{< /r >}}

{{< l a="Ra" >}}This thinking will not be so strange to you. Therefore, we may speak through the densities as your planet has some negatively oriented action in sway at this space/time nexus.
...
The fifth density sees the difficulties posed by the light and in this way directs entities of this vibration to the seeking of targets of opportunity such as this one. If fourth-density temptations, shall we say, towards distortion of ego, etc., are not successful the fifth-density entity then thinks in terms of the removal of light.{{< /l >}}

{{< r a="Don Elkins" >}}When the Orion entity who waits us seeking the opportunity to attack is with us here can you describe his method of coming here, what he looks like, and how he waits? I know that this isn’t too important, but it might give me a little insight into what we are talking about.{{< /r >}}

{{< l a="Ra" >}}Fifth-density entities are very light beings although they do have the type of physical vehicle which you understand. Fifth-density entities are very fair to look upon in your standard of beauty.
...
{{< r a="Don Elkins" >}}Isn’t this unusual that a fifth-density then would bother to do this rather than sending a fourth-density servant, shall I say?{{< /r >}}

{{< l a="Ra" >}}This is correct. Nearly all positive channels and groups may be lessened in their positivity or rendered quite useless by what we may call the temptations offered by the fourth-density negative thought-forms. They may suggest many distortions towards specific information, towards the aggrandizement of the self, towards the flowering of the organization in some political, social, or fiscal way.
...
{{< r a="Don Elkins" >}}Would you tell me what we could do?{{< /r >}}
