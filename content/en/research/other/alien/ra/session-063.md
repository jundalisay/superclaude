...
{{< l a="Ra" >}}
Carla's vital energies are at the distortion which is normal due to psychic attack in the kidneys and urinary tract. There is also distortion continuing due to arthritis.

You may expect this psychic attack to be constant as Carla has been under observation by negatively oriented force for some time.{{< /l >}}

{{< r a="Don Elkins" >}}Was the original problem with the kidneys some 25 years ago caused by psychic attack?{{< /r >}}

{{< l a="Ra" >}}This is only partially correct. 
...
{{< l a="Ra" >}}
Her desire to leave this density lowered the defenses of an already predisposed weak body.
...
{{< r a="Don Elkins" >}}Could you give me a definition of vital energy?{{< /r >}}
...
{{< l a="Ra" >}}This is correct except we may note a small point. The positively oriented harvested entities will remain in this planetary influence but not upon this plane.{{< /l >}}

{{< r a="Don Elkins" >}}Now, we have I believe, if I remember correctly— I think you said there were 600* million Wanderers, approximately. Am I correct in that memory?{{< /r >}}

{{< l a="Ra" >}}This is approximately correct. There is some excess to that amount.*

* The correct number in 1981 was somewhat in excess of 60 million. Ra and Don corrected their mistake in Session 64.{{< /l >}}

{{< r a="Don Elkins" >}}Does that number include the harvestable third density who are coming to this planet for the fourth-density experience?{{< /r >}}

{{< l a="Ra" >}}No.{{< /l >}}

{{< r a="Don Elkins" >}}Approximately how many are here now who have come from other planets third density harvestable for fourth-density experience?{{< /r >}}
...
{{< r a="Don Elkins" >}}Now, are there any inhabitants at this time of this fourth-density sphere who have already gone through this process. Is it now being populated?{{< /r >}}

{{< l a="Ra" >}}This is correct only in the very, shall we say, recent past.{{< /l >}}

{{< r a="Don Elkins" >}}I would assume this population is from other planets since the harvesting has not occurred yet on this planet. It is from planets where the harvesting has already occurred. Is this correct?{{< /r >}}

{{< l a="Ra" >}}This is correct.{{< /l >}}

{{< r a="Don Elkins" >}}Then are these entities visible to us? Could I see one of them? Would he walk upon our surface?{{< /r >}}

{{< l a="Ra" >}}We have discussed this. These entities are in dual bodies at this time.{{< /l >}}
...
{{< r a="Don Elkins" >}}Then at some time in the future the fourth-density sphere will be fully activated. What is the difference between full activation and partial activation for this sphere?{{< /r >}}

{{< l a="Ra" >}}At this time the cosmic influxes are conducive to true-color green core particles being formed and material of this nature thus being formed. However, there is a mixture of the yellow-ray and green-ray environments at this time necessitating the birthing of transitional mind/body/spirit complex types of energy distortions. At full activation of the true-color green density of love the planetary sphere will be solid and inhabitable upon its own and the birthing that takes place will have been transformed through the process of time, shall we say, to the appropriate type of vehicle to appreciate in full the fourth-density planetary environment. At this nexus the green-ray environment exists to a far greater extent in time/space than in space/time.{{< /l >}}

{{< r a="Don Elkins" >}}Could you describe the difference that you are speaking of with respect to time/space and space/time?{{< /r >}}

{{< l a="Ra" >}}For the sake of your understanding we will use the working definition of inner planes. There is a great deal of subtlety invested in this sound vibration complex, but it, by itself, will perhaps fulfill your present need.{{< /l >}}
...
{{< r a="Don Elkins" >}}Is there a clock-like face, shall I say, associated with the entire major galaxy of many billions of stars so that as it revolves, it carries all of these stars and planetary systems through transitions from density to density? Is this how it works?{{< /r >}}
...
{{< r a="Don Elkins" >}}It would seem to me the heating effect that takes place on the planet is analogous to a disease in the body and would have as a root cause the same or analogous mental configuration. Is this correct?{{< /r >}}
