...
Ra:  This is correct, although we have physical energy transferred and available for this working.
...
Ra:  Your query is somewhat opaque. Please restate for specificity.
...
Ra:  We can note the number of such occurrences. There has been only one. We cannot, due to the Law of Confusion, discuss the entity.

69.13 Questioner: You said the higher self is reluctant to enter negative space/time. Is that correct?

Ra:  The incarnative process involves being incarnated from time/space to space/time. This is correct.
...
Ra:  Let us say that the positively polarized individual makes a poor student of the love of self and thus spends much more time, if you will, than those native to that pattern of vibrations.
...
Ra:  This would prevent those levels of meditation which necessarily precede trance. Also in the event that, unlikely as it might seem, the entity grew able to leave the physical complex the auric infringement and tactile pressure would cause the mind/body/spirit complex to refrain from leaving.
...
Ra:  There were no errors. We only remind each that this particular character imaged forth by you was an experienced adept.

69.21 Questioner: You mean the character Trostrick.

Ra:  This is incorrect. We referred to Esmerelda, as this imagined entity was called.
...
Ra:  Although we are unable to speak with precision on this query, we may note some gratification that the questioner has penetrated some of the gist of a formidable system of service and discipline.