...
Ra:  This instrument is under a most severe psychic attack. This instrument is bearing up well due to replenished vital energies and a distortion towards a sense of proportion which your peoples call a sense of humor.
...
Ra:  There is nothing you can do to alleviate the attack. The understanding of its mechanism might be of aid.

57.3 Questioner: Could you tell us its mechanism?

Ra:  The Orion group cannot interfere directly but only through pre-existing distortions of mind/body/spirit complexes.
...
Ra:  This information is harmless, thus we share it though it is transient, lacking the principle but only offering a specific transient effect.
...
Ra:  This is incorrect. There are two recommended configurations.
...
Ra:  There are two advantages to doing this working in such a configuration of shapes and dimensions.
...
Ra:  This is in the affirmative if carefully used.
...
Ra:  Consider the polarity of mind/body/spirit complexes. The inner light is that which is your heart of being. Its strength equals your strength of will to seek the light. The position or balanced position of a group intensifies the amount of this will, the amount of awareness of the inner light necessary to attract the instreaming light upward spiraling from the south magnetic pole of being.
...
Ra:  In this application a pyramid shape may be smaller if the apex angle is less, thus not allowing the formation of the King’s Chamber position. Also efficacious for this application are the following shapes: the silo, the cone, the dome, and the teepee.
...
Ra:  Were all those who desired to be healers of a crystallized nature, and were all supplicants those wishing less distortion, the pyramid would be, as always, a carefully designed set of parameters to distribute light and its energy so as to aid in healing catalyst.
...
Ra:  Your assumption is correct. If the shape is of appropriate size it may be placed directly beneath the cushion of the head or the pallet upon which the body complex rests.
...
Ra:  This question is a large one. We cannot describe initiation in its specific sense due to our distortion towards the belief/understanding that the process which we offered so many of your years ago was not a balanced one.
...
Ra:  This will be the last full query of this working. This instrument has some vital energy left. However, we become concerned with the increasing distortions of the body complex towards pain.
