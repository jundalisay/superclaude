...
{{< l a="Ra" >}}Your fifth-density companion is not accompanying you at this time. However, it is not resting.{{< /l >}}

{{< r a="Don Elkins" >}}Is the censer we have provided all right? They do go out prior to the end of the session. Would it be better if it did not go out prior to the end of the session?{{< /r >}}
...
{{< r a="Don Elkins" >}}Thank you. I would like to ask you as to the initial production of the tarot, where this concept was first formed and where the tarot was first recorded, where did this— the very first concept?{{< /r >}}

{{< l a="Ra" >}}The concept of the tarot originated within the planetary influence you call Venus.{{< /l >}}
...
{{< r a="Don Elkins" >}}I will also assume, which may not be correct, that the present list that I have of the twenty-two names of the tarot cards are not in exact agreement with Ra's original generation of the tarot. Could you describe the original tarot, first telling me if there were twenty-two archetypes? That must have been the same. And if they were the same as the list that I have read you in a previous session or if there were differences?{{< /r >}}
...
{{< r a="Don Elkins" >}}I will ask the following questions to clear up possibly only the method of teaching these concepts which may give me important clues to understanding the concepts themselves. Did Ra use cards similar to the tarot cards for the training purpose in third density?{{< /r >}}

{{< l a="Ra" >}}No.{{< /l >}}

{{< r a="Don Elkins" >}}What did Ra use in third density?{{< /r >}}

{{< l a="Ra" >}}You are aware in your attempts at magical visualization of the mental configuration of sometimes rather complex visualizations. These are mental and drawn with the mind. Another example well-known in your culture is the visualization, in your mass, of the distortion of the love of the One Infinite Creator called Christianity, wherein a small portion of your foodstuffs is seen to be a mentally configured but entirely real man, the man known to you as Jehoshua or, as you call this entity now, Jesus. It was by this method of sustained visualization over a period of training that we worked with these concepts.

These concepts were occasionally drawn. However, the concept of one visualization per card was not thought of by us.{{< /l >}}

{{< r a="Don Elkins" >}}Well, how did the teacher relay information to the student with respect to visualization?{{< /r >}}

{{< l a="Ra" >}}The process was cabalistic; that is, of the oral tradition of mouth to ear.{{< /l >}}

{{< r a="Don Elkins" >}}Then when Ra attempted to teach the Egyptians the concept of the tarot, was the same process used, or a different one?{{< /r >}}

{{< l a="Ra" >}}The same process was used. However, those which were teach/learners after us first drew these images to the best of their ability within the place of initiation and later began the use of what you call cards bearing these visualizations' representations.{{< /l >}}

{{< r a="Don Elkins" >}}Were the Court Arcana and the Minor Arcana a portion of Ra's teachings or was this something that came along later?{{< /r >}}

{{< l a="Ra" >}}Those cards of which you speak were the product of the influence of those of Chaldea and Sumer.{{< /l >}}

{{< r a="Don Elkins" >}}You mentioned earlier that the tarot was a method of divination. Would you explain that?{{< /r >}}

{{< l a="Ra" >}}We must first divorce the tarot as a method of divination from this Major Arcana as representative of twenty-two archetypes of the archetypical mind.
...
{{< r a="Don Elkins" >}}Ra must have had a, shall we say, lesson plan or course of training for the twenty-two archetypes to be given either to those of third density of Ra or, later on, to those in Egypt. Would you describe this scenario for the training course?{{< /r >}}

{{< l a="Ra" >}}This shall be the last full query of this working.
...
As you can see, much work was done creatively by each initiate. We have no dogma to offer. Each perceives that which is needful and helpful to the self.{{< /l >}}
