...
{{< r a="Billy">}}
Sorry I am late, I just could not get away from the house. I sent my wife and the children to the hill behind the forest, and that just took its time. I want to be punctual.
{{< /r >}}


{{< l a="Semjase">}}
That is a very good characteristic of you. Punctuality is very valuable and testifies to responsibility. Unpunctuality testifies to indifference and lack of interest. But it is not your fault you are late now. I do not see a dalliance in you and therefore have monitored your non-arrival at the appointed time. It is really not your fault. But now Pleija, my sister, would like to greet you, see, there she stands between the trees. Just go to her.
{{< /l >}}
...
{{< l a="Semjase">}}
You can still explain the function to me later, but thank my dear friend very much for this. I embrace her in thought.
{{< /l >}}
...
{{< l a="Semjase">}}
You need to negotiate with Quetzal about this.
{{< /l >}}

{{< l a="Quetzal">}}
It is not advisable to leave tracks, but I understand your concern. Also this place is very suitable here and very rarely crossed by human beings, therefore such an undertaking should not be of great danger. It will be possible to meet your wish. We will put our beamships on the supports.
{{< /l >}}
...
{{< r a="Billy">}}
(I walk the few metres through the high grass back to the edge of the forest and step over broken branches and crackling leaves into the forest, where Pleija, Semjase's sister, is waiting for me. I watch her closely as I approach. She's as pretty as Semjase.) Hello, girl, it is so nice to see you. You look just like I imagined you would after my wife told me her dream. You are really very pretty and sweet to bite into. Look, I am about to start nibbling on you.
{{< /r >}}

{{< l a="Pleija">}}
Thank you, you are also greeted with love. You give me great pleasure, never before have I been greeted in such a loving and uncomplicated manner. It is my thanks to you, and the assurance that you touched me very joyfully with your greeting.
{{< /l >}}
...
{{< l a="Pleija">}}
You are very honest and open and I like that very much. You may be a little insecure in the form mentioned, but your behaviour testifies to the fact that you also feel and think according to your words.
{{< /l >}}
...
{{< l a="Pleija">}}
It is not that much, but I came here because I wanted to speak to you face to face. I know the personalities of your earliest past and the very old pictures of them, and so I wanted to see and speak to you for myself.
{{< /l >}}
...
{{< l a="Pleija">}}
I am talking about much earlier times.
{{< /l >}}
...
{{< l a="Pleija">}}
You do not like to talk about those times, so you change the conversation. You are supposed to be dealing with your past of those times.
{{< /l >}}
...
{{< l a="Pleija">}}
Which you are only right for the present time, for at a later date it will become significant.
{{< /l >}}
...
{{< l a="Pleija">}}
Certainly, I am interested in that. The devices are really barbaric, but I would like to try to operate and master them.
{{< /l >}}
...
{{< r a="Billy">}}
(We go across the clearing to my moped, which I then push onto the nearby forest road. For about 15 or 20 minutes I then teach Pleija how to drive the moped. After that there will be a short conversation.) What do you think of my means of transportation?
{{< /r >}}

{{< l a="Pleija">}}
Operating and mastering this device is a rather barbaric adventure, but I find it very interesting. May I use the machine for a slightly longer period of time?
{{< /l >}}
...
{{< l a="Pleija">}}
It would be a delight and a pleasure for me if I could steer around for a few hours with this barbaric machine.
{{< /l >}}
...
{{< l a="Pleija">}}
I have already felt that and I am happy about it. It is a real adventure for me, something I have never known.
{{< /l >}}
...
{{< l a="Pleija">}}
Which you are not wrong about. Come on now, I must go because I have a job to do with Quetzal.
{{< /l >}}

{{< r a="Billy">}}
(We go back together to the ships, which Quetzal and Semjase have settled on the land supports in the meantime.) Semjase, could you perhaps please my wife, the children, Miss Stetter and Mr. Schutzbach, and speed away over them with your ship? They are all waiting on the hill behind the forest.
{{< /r >}}

{{< l a="Semjase">}}
Such an undertaking is particularly dangerous in the daytime. I would be sighted too far around. It is up to Quetzal to decide.
{{< /l >}}

{{< l a="Quetzal">}}
I think it is better if Semjase stays invisible, but maybe there is something I can do. I will monitor the environment and then make up my mind. But it will be difficult to be able to see us, because there are a lot of humans around.
{{< /l >}}

{{< l a="Semjase">}}
Then you can briefly explain the device you brought to me.
{{< /l >}}
