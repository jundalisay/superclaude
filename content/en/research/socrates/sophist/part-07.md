...
{{< l a="Foreigner" >}}
When I spoke of not-being as indescribable and unspeakable and unutterable, in using each of these words in the singular, I refered to not-being as one.
...
{{< l a="Foreigner" >}}
I see, Theaetetus, that you have never made the acquaintance of the Sophist. He will make believe to have his eyes shut, or to have none.
...
{{< l a="Foreigner" >}}
True means that which really is. The not true is that which is the opposite of the true.

A resemblance, then, is not really real, not true.
{{< /l >}}
