...
{{< l a="Foreigner" >}}
In all of these, there is implied a notion of division.

**The art of discerning or discriminating** would be the one art which includes all of them.

In all the previously named processes either like has been separated from like or the better from the worse.

There is no name for the first kind of separation.

The second, which throws away the worse and preserves the better, is called purification.

This is every discernment or discrimination of that kind. 

Any one may see that purification is of two kinds.

There are many purifications of bodies which may be comprehended under a single name.

- There is the purification of living bodies in their inward and in their outward parts, of which the former is duly effected by medicine and gymnastic, the latter by the not very dignified art of the bath-man.
...
THEAETETUS: Yes, I understand. I agree that there are 2 sorts of purification:

1. One of them is concerned with the soul
2. The other is concerned with the body.


{{< l a="Foreigner" >}}
I will try to divide further the first of the two.

Virtue is distinct from vice in the soul.

Purification was to leave the good and to cast out whatever is bad.

Then any taking away of evil from the soul may be called purification.

There are 2 kinds of evil In the soul:

1. Disease in the body
2. Deformity

Perhaps you have never reflected that disease and discord are the same.

Discord is a dissolution of kindred elements, originating in some disagreement.

Deformity is the lack of measure, which is always unsightly.

Opinion is opposed to desire, pleasure to anger, reason to pain.

All these elements are opposed to one another in the souls of bad men. Yet they must all be akin.

Then we are right to call vice a discord and disease of the soul.

When things having motion, and aiming at an appointed mark, continually miss their aim and glance aside,  we say that this is the effect of the lack of symmetry among them.

But surely, no soul is voluntarily ignorant of anything.
...
Then there are these 2 kinds of evil in the soul:
...
This exists only in the soul and so they will not allow to be vice.
{{< /l >}}


THEAETETUS: I now admit that there are 2 kinds of vice in the soul, and that we ought to consider cowardice, intemperance, and injustice to be alike forms of disease in the soul, and ignorance, of which there are all sorts of varieties, to be deformity.
...
This has to do with deformity

2. Medicine

This has to do with disease.
