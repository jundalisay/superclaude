...
BEA is:
- a federal statistical agency under the Office of the Undersecretary for Economic Affairs
<!-- - BEA’s mission is to promote a better understanding of the U.S. economy by providing timely, relevant, and accurate economic accounts data in an objective manner.  -->
- responsible for producing economic indicators such as:
  - the U.S. GDP
  - state and local GDP estimates
  - foreign trade and investment statistics
  - industry data
  - consumer spending numbers

BEA data are used by government and business decision-makers to understand the state of the nation’s economy.

<!-- A new Administration should ensure that BEA conducts its statistical analysis in a consistent and objective manner, with the Undersecretary for Economic Affairs taking a strong interest in BEA’s operations and data products. -->
...
These will need to be placed both in the Census Bureau and in key department-level managerial positions, such as those in the CFO/ASA’s office.
...
This will ensure that budget requests are accurate and up-to-date and allow the new Administration to understand the decennial process in
greater detail.


### Command and control

Strong political leadership is needed to increase
...
The current Administration has announced its intent to change data collection
...
skewed to bolster progressive political agendas. Government data should be unbiased and trusted—and an incoming conservative Administration should
...
### Reevaluate all decennial census questions

Determine how best to optimize use of the decennial census to determine whether current or
...
This is the official five-year measurement of American business and the economy. The first Economic Census in a new
...
During the government’s early response to the COVID-19 pandemic, the Census Bureau began experimental pulse surveys. These
...
After the decennial census, the next biggest statistical survey conducted by the Census Bureau is the American
