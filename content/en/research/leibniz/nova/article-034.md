...
<!-- **34. Heat has the same cause as light,** differing only in degree of subtlety[cite: 1]. Both arise from an internal motion returning into itself, which ejects its more subtle parts; see above section 7 and what follows[cite: 1]. -->
