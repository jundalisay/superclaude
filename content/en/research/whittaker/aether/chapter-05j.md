...
So early as 1830, Cauchy's attention was directed to constructing a mathematical theory of this phenomenon.
- Its basis was Fresnel's "Hypothesis of Finite Impacts"—i.e. the assumption that the radius of action of one particle of the luminiferous medium on its neighbours is so large as to be comparable with the wave-length of light.

Cauchy supposed the medium to be formed, as in Navier's theory of elastic solids, of a system of point-centres of force.

The force between two of these point-centres, m at (x, y, z), and μ at (x + Δx, y + Δy,z + Δz), may be denoted by mμf(r)
- r denotes the distance between m and μ. 

When this medium is disturbed by light-waves propagated parallel to the z-axis, the displacement being parallel to the x-axis, the equation of motion of m is evidently
...
By Taylor's theorem, since `ξ` depends only on `z`, we have
...
Since the luminiferous medium was dispersive only within material bodies, it was natural to suppose that:
- in these bodies the aether is loaded by the molecules of matter, and
- dispersion depends essentially on the ratio of the wave-length to the distance between adjacent material molecules. 

This theory, in one modification or another, held its ground until 40 years later when it was overthrown by anomalous dispersion.

The distinction between aether and ponderable matter was more definitely drawn in memoirs published independently in 1841–2 by:
- F. E. Neumann
- Matthew O'Brien

These authors supposed the ponderable particles to remain sensibly at rest while the aether surges around them, and is acted on by them with forces which are proportional to its displacement. 

Thus, the equation of motion of the aether becomes:
