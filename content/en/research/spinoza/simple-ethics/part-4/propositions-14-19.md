...
c: "indigo"
description: "A true knowledge of good and evil checks our emotion, not by being true, but by the strength of that knowledge."
icon: Spinoza
writer:
  name: Spinoza
...
Reason:
- makes no demands contrary to nature
- demands that every man should:
  - love himself
  - seek that which is useful to him
...
It follows from Postulate 4, Part 2, that we can never arrive at doing without all external things for the preservation of our being or living, so as to have no relations with things which are outside ourselves.

Our intellect would be more imperfect, if mind were alone, and could understand nothing besides itself.

Thus, there are many things outside ourselves which are useful to us and are, therefore, to be desired.
- The most excellent ones are those that are in entire agreement with our nature.

If 2 individuals of entirely the same nature are united, they form a combination twice as powerful as either of them singly.
 
Therefore, the most useful to man and most excellent for preserving their being is when:
- all should agree so in all points
- the minds and bodies of all form one single mind and body
- all should, with one consent, as far as they can, preserve their being and seek what is useful to them all

Hence, men who are governed by reason are those who seek what is useful to them in accordance with reason.

Such men desire for themselves nothing, which they do not also desire for the rest of mankind.

Consequently, they are just, faithful, and honourable in their conduct.
...
This appetite is nothing else but man's nature or essence (Cf. the Definition of Appetite, 3.9. note, and Def. of the Emotions, 1).
