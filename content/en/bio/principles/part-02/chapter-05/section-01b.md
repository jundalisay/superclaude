...
A recent [article in IAI](https://iai.tv/articles/theres-more-to-evolution-than-genes-auid-3126) argues that evolution operates through biological self-modification rather than Darwinian random chance.
...
<!-- Modern biology can describe *what* happens:
- Transposable elements encode transposase proteins
- Heterochromatin marks (H3K9me3, DNA methylation) are associated with these elements
- Stress or developmental signals can activate transposition

But we cannot explain *how*:
- How does heterochromatin "decide" when to activate?
- What directs non-random targeting of insertion sites?
- How are multiple transposable elements coordinated simultaneously?
- What mechanism translates organismal state into specific genomic reorganization?

We know these events occur outside the genes themselves, in the heterochromatin. But the causal mechanism remains mysterious. -->
...
By integrating these perspectives, we move toward a biology that:
- Recognizes organismal agency
- Explains coordinated self-modification
- Reunites ancient wisdom with modern science
- Returns control of life to the living being itself

The question is no longer whether organisms can modify themselves—McClintock proved they do. The question is whether we're ready to accept that this self-modification may be directed by principles our ancestors understood, even if our current scientific framework cannot yet accommodate them. -->

<!-- 
The article asserts that evolution is from biological self-modification instead of Darwinian random chance. 

This is in line with Lamarckism specifically written in Zoological Philosophy Chapter 3. 

The article cites Barbara McClintock's controlling elements as Ac and Ds called transposable elements or jumping genes: https://www.pnas.org/doi/10.1073/pnas.36.6.344

The big problem for biology is that they don't know the mechanism for jumping genes. They just know that it happens outside the genes in the heterochromatin.
...
This is why there are Asian techniques to heal faster by using chi and chakra (e.g. mindfulness, pranic healing, etc). 

So Descartes + Lamarck show how organism evolve themselves instead of relying on chance. This gives the control of life back to the self instead of external causes.
 -->