---
title: "The OpenAI Vortex Points To Descartes"
date: 2026-09-10
image: /graphics/physics/navier.jpg
description: ""
writer:
  name: Juan
...
Recently, the [Open AI team announced](https://openai.com/index/navier-stokes-solution/) that they have proven that the Navier Stokes Equation, which applies Newton's Laws onto liquid dynamics, can abstractly break down. 

They did this by creating a [case](https://cdn.openai.com/pdf/315b36cd-ec98-4023-8342-93345194ece1/euler.pdf) that would challenge Navier Stokes, specifically as a singularity that was far more detailed than ever -- something that AI does very well. 

This then created a complex swirling mathematical vortex that proved that the Navier Stokes Equation was not always "smooth" i.e. could break down. 
...
In fact, we use the same swirl + support equation of liquid dynamics for gravitation (as spin + field) and electromagnetism (as curl + divergence), and even in other sciences such as business (circulating + fixed capital) and sociology (mental spin + population size).
