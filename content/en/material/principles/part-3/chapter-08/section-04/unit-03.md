...
{{< n n="Recall that a spatial vortex in a spatial vortex is called a Coriolis Effect" >}}

Maxwell's 1st Equation shows that the electric flux through a closed surface is proportional to the total charge enclosed by that surface. 
