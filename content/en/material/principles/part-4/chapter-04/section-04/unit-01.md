...
date: 2026-06-12
image: /photos/physics/acids.jpg
description: ""
writer:
  name: Juan
...
<!-- | **Acids**                 | **Bases**                |
|---------------------------|--------------------------|
| Hydrochloric (HCl) – stomach acid | Sodium hydroxide (NaOH) – drain cleaner |
| Sulfuric (H₂SO₄) – car batteries | Ammonia (NH₃) – household cleaners |
| Acetic (CH₃COOH) – vinegar | Calcium hydroxide (lime) – soil treatment |
| Citric – citrus fruits     | Sodium bicarbonate (baking soda) – antacid |
| Carbonic – soda water      | Magnesium hydroxide (milk of magnesia) |

**Everyday neutralization:**  

Antacids (bases) react with stomach acid: HCl + NaHCO₃ → NaCl + H₂O + CO₂. -->
...
<!-- Acids are proton donors or electron-pair acceptors; bases are proton acceptors or electron-pair donors. Their behavior governs everything from digestion and soil chemistry to industrial catalysis. While the Brønsted–Lowry and Lewis frameworks explain most observable chemistry, mysteries persist at the quantum, nanoscale, and extreme-condition frontiers — making acid–base chemistry a deceptively deep field. -->
