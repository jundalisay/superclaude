...
On the other hand, Material Superphysics is based on Cartesian Physics which is based on the aether which is the substance of spirit which is used as Cartesian animal spirits or chi in Taoism and vayu in Hinduism.


All forces come from invisible space (vayu) which is full of energy-particles called 2nd Element (space particles) and 1st Element (electromagnetic). This is roughly similar to quantum field theory. 
...
This gives us 3 types of contact forces:
