...
<!-- Molecules deep inside a liquid are pulled equally in all directions by their neighbors. However, molecules at the very surface have no liquid neighbors above them, so they experience a net inward pull. This creates an internal tension, causing the surface of the liquid to behave like an elastic, stretching skin. This **surface tension** is what allows water striders to walk on water without sinking. -->

2. Spherical Droplet Formation

In the air, liquids form circular blobs since a sphere allows the most staight lines.

<!-- Left to itself—such as falling through the air—a small clump of liquid will naturally form a sphere. Because a sphere has the smallest possible surface area for a given volume, cohesive forces pull the molecules into this shape to minimize surface energy. -->

3. Capillary Action (In Part)
...
<!-- While capillary action (how plants draw water up from their roots) relies on adhesion to grip the walls of microscopic tubes, it is cohesion that holds the water column together, allowing the liquid to be pulled upward in a continuous, unbroken chain. -->
