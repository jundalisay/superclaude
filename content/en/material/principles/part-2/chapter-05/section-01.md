...
These black holes are made up of quanta called quanta of spacetime (qos) as invisible space particles. These are the 2nd Element in Cartesian Physics.
...
<!-- This leads to:
- Galactic gravity from a rotating qos1
- Stellar or Planetary gravity from a rotating qos2
- Centrifugal and centripetal forces from a rotating material object qos3 -->

<!-- ### Why are Galaxies both qos and Qots?

We refer to galaxies as qoss when their nature is confined to a single universe or reality.

We refer to them as qots when their nature is compared to those of other universes or realities. 

Since the current sciences have no knowledge of the properties of other universes or realities, then we will refer to them as qoss. But after humans learn how to teleport to other galaxies then they will be referred to as qots.    

Like qoas (monads), qoss are above the Radiant Layer (Electromagnetism). This makes them likewise invisible and not tangible. For example, you see that there is a space between you and your desk, but you cannot see the properties of that space.
...
Like the aethereal layer, the spatial layer above the radiant layer which facilitates sight and touch. This is why qoss are not visible nor tangible.

Unlike the matter of the Material Layer, qoss are easily divisible, giving them fluid and wave-properties. 
...
Both qos and mos are made up of 4 aether particles that are flat, except for aetherspace particles which are linear and not flat. 
...
All that is needed is an external cause, whether a disturbance from:
...
The properties of qos are detected through the reaction of the lower layers to it. This can be done through passive observation.
...
<!-- From these, we can plainly see that the qoss around our table is very different from those in the supermassive black hole of a galaxy. 

In planets, a planetary qos is detected by the behavior of mass around it. 

The qos of a heavenly body in Physics is the Schwarzschild Radius of that body. For example, a galaxy's qos is the event horizon of its supermassive black hole. 

The qos of a planet such as the Earth is the Schwarzschild Radius of the Earth which is 1 centimeter, while that of the sun is 3 kilometers.
-->
