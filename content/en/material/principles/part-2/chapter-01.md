...
The spatial layer is below the aethereal, as the 'container' of physical reality.
...
The Spatial Layer is where physical perceptions, and therefore physical reality, take place. 

Its main job is to separate identities.
...
- Parts that have low kinetic energy or aether manifest as empty space or a vacuum
- Parts that have high kinetic energy or aether manifest as vortices. This is similar to a hurricane

Since the Spatial layer is purely kinetic then spatial forces and particles (as media and quanta) are interchangeable.


{{< f f="*The static form as aetherspace in the nucleon of an atom is technically more attached to the Material Layer more than to the Spatial." >}}



The Spatial layer leads to spacetime and sets the speed of light, since it is superior to the 3 lower Layers of:
- Electromagnetism or Radiant Layer
- Weak Force or Convertible Layer
- Strong Force or Material Layer
