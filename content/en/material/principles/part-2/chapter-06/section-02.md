...
icon: "Juan"
aliases:
  /material/principles/part-2/chapter-06c
---


Rule 2 of Descartes' Rules of Motion says that every moving body moves..
...
1. When the body deviates from a straight line motion because it is physically bound to a center
...
2. When the body deviates from a straight line motion without being bound to anything.
...
{{< i s="/photos/physics/skates.jpg" a="Centrifugal and Centripetal" >}}

<!-- When they pull their arms in, they reduce the centrifugal effect and spin faster due to conservation of angular momentum -->
...
<!-- In some cases, the body rotates and forms a vortex. 

For example, in a planet: 
- The inner part experiences the centrifugal force as bulging along the equator  -->
<!-- (Rule 2) -->
<!-- - The outer part experiences the centripetal force as gravity  -->
<!-- (Rule 3) -->
...
<!-- the Kepler Harmonic Ratios, as the effects of Cartesian Relationality, should be applied to find the optimal balance of forces. -->
