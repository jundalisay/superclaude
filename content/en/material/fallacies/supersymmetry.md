...
So both of them are just 2 sides of the same fallacy coin caused by the simultaneity of time fallacy.
...
- This is because, in Cartesian Physics, the true cause of simultaneity is the 5th Element called the aether -- since time is mental and not physical
- But Einstein's simultaneity is based on light (1st Element) and so does not match Nature or reality -- this time is physical or light-based or exposed by light
  - In a universe of total darkness and silence and no tangibility, we would not perceive any physical change so there would be no time
...
- Relativity is false because time is mental (5th Element), not electromagnetic (1st Element).
