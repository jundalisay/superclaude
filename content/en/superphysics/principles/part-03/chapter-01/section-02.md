...
In some parts of Existence, many waves intersect from various angles to create concentrations as plena.

These plena are unique from the rest of the normal distribution of waves. This uniqueness makes them discrete nodes.

- In the Metaphysical domain, these manifest as ideas.
- In the Quasiphysical domain, these manifest as space, times, dimensions, densities, or universes.
- In the Physical domain, these manifest as bodies.

We can say that:
- waves are feelings or forces
- nodes are ideas or particles

<!--  These acquire characteristics that are different from waves and become ideas.
...
## Diversity of Waves in a Plenum
