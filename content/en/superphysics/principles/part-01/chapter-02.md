...
The 3 Domains are **static** classifications of phenomena with a hierarchy as the metaphysical being superior to the physical. 

1. Metaphyiscal - This is abstract
2. Quasiphyiscal - This is in between
3. Phyiscal - This is tangible


The active phenomena, as studied by the sciences, occur and live in the 3 Operational Divisions within Existence that we call can perceive as the physical, biological, and mental.

We know that:
- our abstract ideas cannot be seen by other people
- life has both physicality as body, and metaphysicality as mind
- physical things have no mind of their own

Domain | Operational Division
--- | ---
Metaphysical | Abstract
Quasi-Physical | Biological
Physical | Material


{{< i s="/graphics/super/operative.jpg" a="3 Operational Divisions" c="">}}
...
As you can see, the Physical Division has the most negativity, while the Mental Division has the most positivity. This will be discussed on the Chapter on Postive and Negative



## Leads to the 15 Layers and Branches of Superphysics

The 5 Elements applied onto the Operational Divisions lead to the 15 layers of phenomena.

{{< i s="/graphics/super/operative.svg" a="3 Operational Divisions" c="">}}

We use this to create the branches of Superphysics:

Mental | Biological | Material
--- | --- | ---
Superphysics | Bio Superphysics | Material Superphysics
Supermath | | 
Social Superphysics | | 
Superhistory | | 
Superlogic | | 
