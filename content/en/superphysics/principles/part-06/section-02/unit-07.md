...
icon: "Juan"
aliases:
  /superphysics/principles/chapter-8k
  /superphysics/principles/chapter-08/section-11
---



Socratic Dialectics is based on using the Positive Force to solve problems.

This is because problems happen when things go out of their dharma or true nature. 

To restore things to their true nature, Socratic Dialectics probes those things to expose the negativity in their waves. This leaves only the strongest waves which are the cause of the problem.

The solution is then arrived by working with those waves in a Positive way either as a compromise or a gradual removal or softening of those Negative waves.  


## Classification from Probing

The hunt for the dharma requires:
- all six senses, the 6th being intuition
- the ego to be lowered

This is why Socrates called the search for the True Nature more laborious than the sciences.
- This is why few people know their True Nature. 


For example, an alternative cancer cure that works for Mr. X might not work for Mr. Y.
- This would make it unacceptable to 'scientific' modern medicine which throws away such useful cures. 
...
Other civilizations have used such a metaphysical classification system. 

For example, the Japanese believe that human behavior can be categorized according to 4 blood types, which was pseudo-science [until Covid came](https://www.tmc.edu/news/2020/06/blood-type-may-affect-covid-19-outcomes-study-shows/). 

<!-- Moreover, assert that negative RH blood is  -->
...
Are we perfecting natural philosophy alone according to our method? Or the other sciences also, such as logic, ethics, politics? **We certainly intend to comprehend them all.**
{{< /q >}}
