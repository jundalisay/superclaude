...
aliases:
  /superphysics/principles/chapter-03f
---
...
This great loop manifests to us as the cycle of creation which starts in a Negative Direction from the Negative Force.
...
This creates physical reality. It then switches into the Positive Direction thanks to the Positive Force.

5. Life originates in matter through the Positive Force
...
Material Superphysics deals with the Negative Direction as the creation from the aether into materiality. 

Bio Superphysics and Spiritual Superphysics deals with the Positive Direction from materiality into the aether or spirituality



## Mentality Creates Reality

The 5 Elements show the journey of an idea of the Supreme from metaphysical into physical reality. 

1. The Supreme Entity has an idea in the Aethereal Element.
2. It is then deployed through a galaxy in a universe in the Air Element (space).
3. It then spreads as particles through the Fire and Earth Element (electromagnetism and Strong Force) made varied by the Water Element (Weak Force).

This is also true for any phenomena:

1. You have an aethereal idea to bake a cake.
2. You walk to the space (Air Element) in the kitchen where the ingredients are.
3. You put the material ingredients (Earth Element), such as flour, together through intermolecular forces (Water Element)
4. You put bake them using heat (Fire Element)

{{< i s="/photos/objects/cake.jpg" a="Cake" >}}

The whole process of making the cake begins with the idea and feeling to bake cake. The whole process stops it the desire to finish the process also stops. 

This is why “mentality creates reality”. 

This truth is perpetually challenged by materialists who believe that the matter (Earth Element) is superior to idea and feeling (Aether).

And so they put forth the opposite maxim “seeing is believing” or “matter creates mind”. 
...
This materialist doctrine goes against the order of Nature by making matter superior to the aether. 

It is no wonder that Communist and Capitalist systems* collapse by themselves from the inside instead of from any external force:
- The fall of the Soviet Union was begun by Gorbachev
- The 2008 Financial Crisis was begun by Wall Street banks 

{{< n n="*Communism is based on dialetical materialism, specifically the dominance of matter. Capitalism is based on economic materialism, specifically the love for money" >}}
...
The superiority of the aether over matter is proven by mind over matter and by grit creating success despite material adversity. 
