...
Aspect | Meaning
--- | ---
**Intelligence** | Its end result is understanding. We define intelligence as the ability to combine and harmonize multiple reasonings or logics of cause and effect together
**Natural** | Its understanding came from humans. We define Nature as the physical aspects of the Supreme Entity
**Automated** | It developed and increased that understanding by itself


## The Cause of Intelligence: The Aether and the Positive Force

In Superphysics, everything is a metaphysical idea of the Supreme which flows down into physical reality to be experienced.

This experience then matches or validates the idea of it, closing the loop from idea to experience and back to the understanding of the idea. 
- This is the Great Loop of Cause and Effect with the Generator-Mind as the Cause and the Generated-Ideas as the Effect.

{{< i s="/graphics/meta/flow.png" >}}


Ideas are in the aetheral element or layer and therefore can only be processed by an aethereal object like a mind or a soul. 

Material thoughts, on the other hand, can exist in the fire element or layer, now called Electromagnetism by Physics.

For example:
- this text here on this website is electromagnetic, and counts as electromagnetic thoughts since they represent coherent ideas, as opposed to being random data
- the text on paper is material ink, but is made known by light which is part of the electromagnetic spectrum 


The problem is that thoughts are **totally static** compared to ideas. They need external energy applied onto them to create connections with other thoughts. This application of energy is called **thinking** which uses both mental flow and force. 
