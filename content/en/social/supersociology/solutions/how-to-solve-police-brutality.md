...
However, from the nature of things, this is the wrong solution. If you had a personal chauffer (driver) who was reckless and has caused the deaths of others, you do not ban all chauffers and make people drive their own cars. 

Some people might suggest re-training the chauffers to make them more careful. However, this cannot be 100% effective because the recklessness might be innate to some chauffers.
...
In law enforcement, this would mean making morality and sociability as the top requirements for applicants for the job of police officer.
...
Law enforcement is part of the overall justice system, with the police handling the task of enforcing justice.

According to David Hume, justice is an artificial system arising from 2 factors:

1. The selfishness of humans
2. The scarcity of resources

{{< q a="David Hume" c="The Treatise of Human Nature Simplified, Book 3, Part 2, Section 3" >}}
...
**The problem is that everyone’s needs are different**. A granular allocation of resources is impossible in the current money-based system.

And so socialist countries implemented rationing.

<!-- This is why utopian socialism naturally mutated into Communism.  -->

But rationing is oppressive and also expensive to operate.

This makes scarcity slowly creep back in with every allocation, leading to the poverty seen in Communist states.
...
- If the society is generally **immoral**, it will lead to a mafia-style law enforcement which prioritizes certain groups at the expense of others. An extreme example is the Praetorian guard which sold the office of emperor to the highest bidder. This is what narco-states and corrupt nations have. i.e. the drug gangs have more funding which reveals the underfunding of the police

As you can see, defunding the police, either by funding community-based law enforcement or giving more resources to people, will have negative consequences in the long term. 

<!-- It arises from minds who do not know the metaphysical causes of things. This makes them propose solutions which are obvious to all, yet shallow in thought.  -->


The solution is like reinventing the wheel to solve the problem of a tire that goes flat regularly, when the real cause is simply the owner neglecting his duty to maintain the tire pressure at specific intervals.
...
Our solution, which builds on Hume's causes therefore has 2 parts:

1. Economic part to deal with the scarcity

This is discussed in [Supereconomics](https://www.amazon.com/Supereconomics-Nutshell-Based-Four-Value-ebook/dp/B0F1G35KPF)


2. Moral part to deal with the selfishness
...
## Update May 2026: The Sassani Solution

We can verify our solution with the suggestion by the Sassani who suggested that the military and police officers will not do their duty as slaves following orders. 

Instead, they will discern the situation themselves as they are taught of the metaphysics of how life and souls actually work. 
