...
<!-- . This represents the force from the metaphysical Creator of humans (shiva) and the physical Nature where humans exist (shakti).  -->
...
<!-- Note that such a pattern really represents the cycle of Western society which has imposed itself on the rest of the world through colonialism. The political and economic systems of most countries are based on the European system of:
...
<!-- This had to be relieved by a World War as a reboot of the Western society-organism*. -->
