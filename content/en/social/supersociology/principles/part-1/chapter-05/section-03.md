...
It combines:
- **David Hume**'s explanation of the dynamics of the mind
- **Socrates**' cycles which match the Hindu Varnashrama system and the Egyptian class system
...
1. Selfishness-Nonselfishness 

This is a function of ego or the entity observing existence. This is really caused by the Positive and Negative Forces (Yang and Yin):
- Selfishness is from the Negative Force.
- Non-Selfishness is from the Positive 

<!-- (though from the perspective of the self, selfishness can be seen as Positive and selflessness as Negative) -->


2. Objectivism-Nonobjectivism 

This is from the body-mind duality, arising from the 2 Forces splitting reality into physical and metaphysical.
- Objectivity and Physicality are from the Negative
- Subjectivity and Abstrations are from the Positive

<!-- a function of the natural duality of existence, or physics versus metaphysics, within space-time
Objectivism is from the Negative Force. Subjectivism (respecting the opinion of others) is from the Positive -->


3. Social cycles

This is a function of how the ego changes from Selfish to Nonselfish and back, and from Objective to Subjective and back.

<!-- in duality in different space-times, as how the Positive and Negative fight each other -->
...
1. The tyrannical Mongol Yuan dynasty was overturned by the aristocratic Ming dynasty
2. The Ming gradually turned oligarchic as it focused on trade and its Treasure fleet
3. This was reversed by peasant-dominant Qing dynasty
4. The Qinq was overturned by Communist tyranny

<!-- - the Ming Hong Wu emperor was later overturned by the isolationist policy of the more-democratic 
- finally, it was  -->
...
1. The oligarchy of George W. Bush being overturned by the democracy of Obama
2. The democracy of Obama being overturned by the tyranny of Trump 
...
The plotting of these abstract ideas and ideologies through time exposes how they change through the years. 

For example:

- The Communism in China under Mao is differnt from the Communism of Xi which has state capitalism. (We can say that China's Communism has moved towards more personal selfishness, but still not as selfish as Western Capitalism)
- The belief in Jesus of the Catholic church is different from the belief of the modern evangelical churches. (The modern era has changed Jesus from a non-objective spiritual Saviour into an objective prosperity giver)
- The Big Bang theory during the time of Einstein is different from the modern Lambda CDM model. (The modern theory is more objective because of the data from modern telescopes)  

These movements of ideas can be thought of as vectors in a vector space which we call the perception space.

The goal of Superphysics is to move human ideologies towards the center by applying both a pull and push tactic. 
- This is similar to the hammer and anvil approach of Alexander the Great.
...
- in liberal countries like the US and Europe, materialism can be checked by pushing people towards abstract non-objective ideas like reciprocity and common interest
...
We have made a prototype web app that plots the cycles of certain countries: https://predict.superphysics.org/