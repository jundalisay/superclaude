...
The original prediction in 2015 (from the model made in 2012) was that a crisis was supposed to spark in Q1 2018 which will start a stagflation process by 2019. 

This spark would be small. Back in 2015, we were looking at the following possibilities:

1. A tiny country sparking a global financial crisis. This is why we prototyped [a free trade system that allowed foreign trade even without money](https://www.pantrypoints.com/trisactions/world/)
2. A tiny thing like cryptocurrency creating a financial crisis. A precedent is the 'flash crash'. For this, we prototyped [Points Banking](https://pantrypoints.com/trisactions/banking/) that allowed used points as a store of value
...
The 'tiny-ness' of the spark for the crisis is [explained by Adam Smith](/social/economics/fallacies/profit-maximization-is-absurd) as 'the straw that breaks the camel's back'.

This is similar to the 'butterfly effect'. However, the butterfly effect is not so accurate because it is not based on patterns and is just based on chance.   
...
According to the model, that spark would cause a long, drawn out global stagflation, climaxing in some kind of conflict, similar to how the Crash of 1929 led to a Great Depression which ended up as World War 2.

The first years would seem dire, **but are actually better than the years to follow**.

After the crisis years are over, then things become happier than before the crisis years, since the job of the crisis years was to remove the prevailing human dogmas that caused so much suffering not only for humans, but also for plants and animals. 

This is similar to how the European Union came about from the horrors of World War 2. 

{{< img src="/graphics/social/predict.jpg" cap="Original Prediction" alt="Original Prediction" >}}

{{< img src="/graphics/social/predict2023.jpg" cap="Actual from 2023" alt="Update: Actual from 2023" >}}
...
The arrival of Omicron isn't surprising because it proves the universe works as predicted.

The emergence of Omicron in Botswana-South Africa, instead of Indonesia or Malaysia, led us to our hypothesis that Covid came from [a Covid star](/bio/solutions/covid-star). 

<!-- focusing on quality instead of quantity.* -->

The Socratic dialectical solution to Covid is to stop the war against the Amazon rainforest through two major policies: 

1. An embargo the Amazon rainforest, and later, those in Indonesia and Africa, enforced by NATO
2. A super-massive reforestation global as reparations for the damage done, as well as to reverse climate change

This solves two problems -- Covid and global warming -- at the same time. 

{{< n n="Update 2023: It would have diverted NATO away from Ukraine and into Brazil, preventing the Russia-Ukraine war" >}}


This solution is sourced not from intellect or brain, which is what the West excels in, but from fellow-feeling or heart which is what Asia excels in. 
...
A shallow reader might think that Superphysics is anti-vaccination. In reality, Superphysics is pro-vaccination just as it is pro-alternative medicine. 

The issue here is the excessive dependence on a certain tool, similar to a person who uses a calculator to add simple numbers instead of using his own brain.  
