...
To explain why, we shall apply Socratic Dialectics by:
- getting real data
- matching that data with the abstract flow of ideas and feelings

This will create a pattern of cause and effect.

The feelings of society* and of its leaders are the core of Social Superphysics which allows it to predict events in and between societies.  
...
## The Balance of Power is Based on the Preservation Instinct

<!-- The Feelings of Putin and Russia -->

Putin's feelings were made known in his speech on February 21 wherein he blamed the incursion of NATO and the EU into Ukraine.

He said that this violated their 1994 Agreement to keep Ukraine away from the military and economic influence of both Russia and the US-UK.

This has been clear and known to the relevant world leaders.

This feeling is based on the "balance of power" which is a concept from the 18th century.

It was unknown in ancient Europe but seems to have been known in China, as proven by Sun Tzu's Art of War:


{{< q a="Sun Tzu" c="The Art of War, Chapter 1 and 4" >}}
The Moral Law causes the people to be in complete accord with their ruler, so that they will follow him...The consummate leader cultivates the moral law and strictly adheres to method and discipline. Thus it is in his power to control success.
{{< /q >}}
...
Putin's war in Ukraine is his attempt to preserve the balance of power to secure the existence of Russia. This balance was lost after NATO destroyed Iraq and Libya, and nearly destroyed Syria*. 

{{< d t="Update Dec 2024" >}}
The fall of Syria to Islamists, indirectly supported by Israel's attacks on Syria, proves that Putin's fears were valid.
{{< /d >}}


 <!-- The current war is really between the 2 Negative Forces as the financial industry (Trader Class) and autocratic leaders (Warrior Class). The Negative Worker Class gets mixed is as populists, along with some Negative Thinker class as Islamists.   -->
...
The problem began when the Mongols invaded. Ukranian cities like Kiev refused to surrender their freedom, but Russian cities like Novgorod surrendered (possibly being used to non-freedom). 
...
The social cycles of Western mentalities have a lifespan of 8 cycles lasting 480 years on average. 

It shows that Russia:
- is in its 5th cycle which began with Catherine the Great who annexed Ukraine from Poland and the Crimea from Turkey. 
- entered a militant cycle in 2022, which explains why it launched its attack this year instead of in 2014 after Euromaidan.
...
So we know why Russia (and Belarus) is doing what it's doing. 
...
Unfortunately:
- the West is still infected with the Liberalism virus from the French Revolution
- Russia is still very much entrenched in Catherine the Great's imperialism

These 2 opposing forces clash in Ukraine. 

This disturbance has its roots in the fall of the Soviet Union which then has its roots in World War 1, and then to Napoleon, and then to **the French Revolution**, matching cause with effect. 
...
## The US Pushes Freedom Just to Make More Money
