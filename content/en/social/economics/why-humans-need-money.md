...
<!-- Productive work is work that creates a thing while unproductive work is work that doesn't (like singing).  -->
...
For example, bitcoin is not wealth because it is merely a cryptographic hash in computer memory. This is even if it allows real goods to circulate.
 ...
 <!-- and be experienced by the human minds that make up society.  -->
