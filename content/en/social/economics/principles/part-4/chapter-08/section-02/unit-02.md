...
<!-- funnels taxpayer money into projects that are run by private corporations which charge a premium for those projects compared to those run by state-owned enterprises.  -->
...
{{< i s="/graphics/econ/crisis.jpg" a="Solutions" >}}
...
We will explain the proper solutions to the Great Depression in the Solutions part.
