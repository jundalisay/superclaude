...
<!-- If we plug the idea of money into our 5 Strata model, we find that it occupies the lowest stratum. 

This is because, as a reprsentative number, it is purely quantitative and not qualitative. This makes it very precise, but at the expense of losing other information. 

{{< i s="/graphics/econ/quality.jpg" a="Quality vs Quantity" c="'3 tomatoes' has only 2 pieces of information, whereas the actual 3 tomatoes have so much more. We can say that quantification loses information for the sake of precision and speed" >}}
...
However, you might not be aware that some of your staff are contributing in **non quantative, intangible means** to the success of your company. 

Relying too much on quantitative information alone would therefore lead to bad decisions. 

However, qualitative information:
- would be hard to define, or
- might cause information overload
- might incur a cost to collect.

**The removal of qualitative information in favor of quantitative information reflects the limiting tendency of the Negative Force.** 
