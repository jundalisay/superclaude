...
Just before the wave goes flat, the utility that you get is "marginal". This feeling tells you to stop buying since the desire has been satisfied.
...
For example, if you can only eat 5 slices of pepperoni pizza, then your maximized utility is likely at 4 slices. 

If 1 slice of pepperoni pizza is $1, then you will conclude that $4 is the optimal money you should bring to the pizza store. 

But what if there is no pepperoni pizza available? Or what if the store is closed and you have to go to a sandwich shop instead? Your $4 will not produce the same result. 
...
The  Even use value is subjective

Each person has a different utility function for a product

 subjective.** Metaphysically, it is caused by the constant fight between the 2 Forces of Positive and Negative.
